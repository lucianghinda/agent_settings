...
doc_with_updated_links = llm_doc.gsub(%r{\[AgentSettings/}, "[doc/AgentSettings/")
doc_with_updated_links = doc_with_updated_links.gsub(%r{\(AgentSettings/}, "(doc/AgentSettings/")
File.write(llm_path, doc_with_updated_links)
